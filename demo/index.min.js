...
var tokensCss = i$4`:host{--ds-auro-lockup-alaska-logo-color: var(--ds-color-brand-lounge, #01426a);--ds-auro-lockup-divider-color: var(--ds-color-border-divider-default, rgba(0, 0, 0, 0.12));--ds-auro-lockup-subtitle-color: var(--ds-color-text-tertiary-default, #6a717c);--ds-auro-lockup-title-color: var(--ds-color-text-info-default, #326aa5)}`;
